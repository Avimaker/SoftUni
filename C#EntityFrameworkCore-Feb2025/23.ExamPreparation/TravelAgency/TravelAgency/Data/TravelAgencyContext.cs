...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=localhost,1433; Database=TravelAgencyDb; User Id=SA; Password=SoftUni2025; TrustServerCertificate=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure composite primary key for TourPackageGuide
            ...
            modelBuilder.Entity<TourPackageGuide>()
                .HasOne(tpg => tpg.TourPackage)
                .WithMany(tp => tp.TourPackagesGuides)
                .HasForeignKey(tpg => tpg.TourPackageId);

            modelBuilder.Entity<TourPackageGuide>()
                .HasOne(tpg => tpg.Guide)
                .WithMany(g => g.TourPackagesGuides)
                .HasForeignKey(tpg => tpg.GuideId);
