...
namespace NetPay.Data
{
    ...
    {
        private const string connectionString = @"Server=localhost,1433; Database=NetPayDb; User Id=SA; Password=SoftUni2025; TrustServerCertificate=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder
                ...
                .HasKey(ss => new { ss.SupplierId, ss.ServiceId });//composite key

            modelBuilder
                .Entity<SupplierService>()
                .HasOne(ss => ss.Supplier)
                .WithMany(s => s.SuppliersServices)
